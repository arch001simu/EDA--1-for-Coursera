...
plot(eda1$ntime,eda1$Sub_metering_1,type='l',xlab="",
     ylab = "Energy sub metering")
lines(eda1$ntime,eda1$Sub_metering_2,type='l',col="red")
lines(eda1$ntime,eda1$Sub_metering_3,type='l',col="blue")
